fetch(
    'https://youtube.googleapis.com/youtube/v3/search?part=snippet&maxResults=30&q=%EB%8C%80%EA%B5%AC%20%EB%8F%99%EC%84%B1%EB%A1%9C&type=video&videoDefinition=high&videoEmbeddable=true&videoSyndicated=true&key=AIzaSyDtRc2E1eLwf9L_bokvQYZ5dVKYZExNGNc'
)
    .then((res) => res.json())
    .then((data) => {
        const words = [
